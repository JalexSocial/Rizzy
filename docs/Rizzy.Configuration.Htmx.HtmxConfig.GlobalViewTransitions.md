...
## HtmxConfig.GlobalViewTransitions Property
...
If set to [true](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/bool 'https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/bool'), htmx will use the View Transition API when swapping in new content.

```csharp
public System.Nullable<bool> GlobalViewTransitions { get; set; }
```
