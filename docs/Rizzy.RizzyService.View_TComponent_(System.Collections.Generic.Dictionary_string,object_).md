...
## RizzyService.View<TComponent>(Dictionary<string,object>) Method
...
<a name='Rizzy.RizzyService.View_TComponent_(System.Collections.Generic.Dictionary_string,object_).TComponent'></a>
...
<a name='Rizzy.RizzyService.View_TComponent_(System.Collections.Generic.Dictionary_string,object_).data'></a>
